...
class SigLipVisionTower(nn.Module):
    def __init__(self, vision_tower, vision_tower_cfg, delay_load=False):
        ...
        if type(self.select_layer) is str:
            self.select_layer = json.loads(self.select_layer)
    ...
    def forward(self, images):
        ...
        if type(self.select_layer) is list:
            ...
            image_features = []
            for layer_idx in self.select_layer:
                image_features.append(image_forward_outs.hidden_states[layer_idx].to(images.dtype))
        else:
